    ...
    <div id="static-acia-cred">
      ...
      <ul className="main-list">
        <li>
          ...
          <p>
            É necessário: – <a target="_blank" style={{ color: 'red' }} href="/documents/Ficha de Cadastro de Funcionario e Dependente.pdf">Preencher o RQ.18 – Clique aqui para baixar a ficha de cadastro: Ficha de Cadastro de Funcionário e Dependente</a>; efetuar o pagamento da
